...
const FILES: string[] = [
  ...
  resolve(root, "src/firstrun/walkthrough.ts"),
  resolve(root, "src/importer/Importer.tsx"),
  resolve(root, "src/importer/csv.ts"),
  resolve(root, "src/importer/appleHealth.ts"),
  resolve(root, "src/importer/mergeDays.ts"),
  resolve(root, "src/journal/Journal.tsx"),
  resolve(root, "src/journal/Backup.tsx"),
  resolve(root, "src/journal/reminder.ts"),
  resolve(root, "src/state/backup.ts"),
